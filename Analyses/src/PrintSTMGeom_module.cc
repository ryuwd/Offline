...
#include "StoppingTargetGeom/inc/StoppingTarget.hh"          // for Stopping...
#include "CosmicRayShieldGeom/inc/CosmicRayShield.hh"        // for CosmicRa...
#include "DetectorSolenoidGeom/inc/DetectorSolenoid.hh"      // for Detector...
#include "STMGeom/inc/STM.hh"                                // for STM
#include "art/Framework/Core/EDAnalyzer.h"                   // for EDAnalyzer
#include "art/Framework/Core/ModuleMacros.h"                 // for DEFINE_A...
#include "CLHEP/Vector/ThreeVector.h"                        // for Hep3Vector

#include "ConfigTools/inc/SimpleConfig.hh"                   // for SimpleCo...
#include "CosmicRayShieldGeom/inc/CRSScintillatorLayer.hh"   // for CRSScint...
#include "CosmicRayShieldGeom/inc/CRSScintillatorModule.hh"  // for CRSScint...
#include "CosmicRayShieldGeom/inc/CRSScintillatorShield.hh"  // for CRSScint...
#include "GeometryService/inc/GeometryService.hh"            // for Geometry...
#include "STMGeom/inc/PermanentMagnet.hh"                    // for Permanen...
#include "STMGeom/inc/STMCollimator.hh"                      // for STMColli...
#include "STMGeom/inc/ShieldPipe.hh"                         // for ShieldPipe
#include "StoppingTargetGeom/inc/TargetFoil.hh"              // for TargetFoil
#include "art/Framework/Services/Registry/ServiceHandle.h"   // for ServiceH...
#include "canvas/Utilities/Exception.h"                      // for Exception
#include "fhiclcpp/types/AllowedConfigurationMacro.h"        // for AllowedC...
