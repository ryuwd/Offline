...
void CosmicAnalyzer::beginJob()
{
    ...
    if (_diag > 0) {
        ...
        if (_mcdiag) {
            ...
            _seedDeltaA1_v_minuitA1 = tfs->make<TH2F>("#Delta A^{seed-MC}_{1} v A^{straw}_{1}",
            ...
            _seedDeltaB1_v_minuitB1 = tfs->make<TH2F>("#Delta B^{seed-MC}_{1} v B^{straw}_{1}",
        ...
        _reco_phi_angle = tfs->make<TH1F>("#phi Angle of Reconstructred Track",
        ...
        _seed_b0 = tfs->make<TH1F>("Seed  Track Parameter B0 ",
        ...
        _seed_b1XYZ = tfs->make<TH1F>("Seed Track Parameter B1 XYZ ",
        ...
        _Seed_Cov_A0A1 = tfs->make<TH1F>("Seed #sigma_{A_{0}A_{1}}",
        ...
        _Seed_Cov_B0B1 = tfs->make<TH1F>("Seed #sigma_{B_{0}B_{1}}",
        ...
        _change_chisq_ndf_plot_X = tfs->make<TH1F>("Seed Total Change in Chisq/ ndf X''",
            "Total Change in Chisq/ ndf X''", 50, -10, 20);
        _change_chisq_ndf_plot_X->GetXaxis()->SetTitle(
            "Initial X '' #Chi^{2}/N");

        _change_chisq_ndf_plot_Y = tfs->make<TH1F>("Seed Total Change in Chisq/ ndf Y''",
            "Seed Total Change in Chisq/ ndf Y''", 50, -10, 20);
        _change_chisq_ndf_plot_Y->GetXaxis()->SetTitle(
            "Initial Y '' #Chi^{2}/N");

        _change_chisq_ndf_plot_Total = tfs->make<TH1F>("Seed Total Change in #Chi^{2}/ ndf",
            "Seed Total Change in #Chi^{2}/ ndf", 50, -5, 20);
        _change_chisq_ndf_plot_Total->GetXaxis()->SetTitle(
            "Total Change in #Chi^{2}/ndf");

        _total_residualsX_init = tfs->make<TH1F>("Seedf Initial Residuals X'' ",
        ...
        _total_residualsY_init = tfs->make<TH1F>("Seed Initial Residuals Y''",
        ...
        _total_pullsX_final = tfs->make<TH1F>("Seed Final Pull X'' #chi^{2}/dof alSeed l ",
            "Seed Final Pull X''#chi^{2}/dof all ", 50, -2, 2);
        _total_pullsX_final->GetXaxis()->SetTitle("Final Pull X''");

        _total_pullsY_final = tfs->make<TH1F>("Seed Final Pull Y''#chi^{2}/dof all ",
        ...
        _total_residualsX_Minuit = tfs->make<TH1F>("Minuit Residuals X''  ",
        ...
        if (_mcdiag) {
            ...
            if (st.MinuitFitParams.Covarience.sigA0 != 0) {
                _A0MinuitMCDiff->Fill(
                    (trueinfo.TrueFitEquation.Pos.X() - st.MinuitFitParams.A0)); ///(st.MinuitFitParams.Covarience.sigA0));
            }
            if (st.MinuitFitParams.Covarience.sigA1 != 0) {
                _A1MinuitMCDiff->Fill(
                    (trueinfo.TrueFitEquation.Dir.X() - st.MinuitFitParams.A1)); ///(st.MinuitFitParams.Covarience.sigA1));
            }
            if (st.MinuitFitParams.Covarience.sigB0 != 0) {
                _B0MinuitMCDiff->Fill(
                    (trueinfo.TrueFitEquation.Pos.Y() - st.MinuitFitParams.B0)); ///(st.MinuitFitParams.Covarience.sigB0));
            }
            if (st.MinuitFitParams.Covarience.sigB1 != 0) {
                _B1MinuitMCDiff->Fill(
                    (trueinfo.TrueFitEquation.Dir.Y() - st.MinuitFitParams.B1)); //(st.MinuitFitParams.Covarience.sigB1));
            }
            ...
            _seedDeltaA0_v_minuitA0->Fill(trueinfo.TrueFitEquation.Pos.X() - st.FitEquationXYZ.Pos.X(),
                st.MinuitFitParams.A0);
            _seedDeltaB0_v_minuitB0->Fill(trueinfo.TrueFitEquation.Pos.Y() - st.FitEquationXYZ.Pos.Y(),
                st.MinuitFitParams.B0);
            _seedDeltaA1_v_minuitA1->Fill(trueinfo.TrueFitEquation.Dir.X() - st.FitEquationXYZ.Dir.X(),
                st.MinuitFitParams.A1);
            _seedDeltaB1_v_minuitB1->Fill(trueinfo.TrueFitEquation.Dir.Y() - st.FitEquationXYZ.Dir.Y(),
        ...
        for (size_t i = 0; i < sts._straw_chits.size(); i++) {
            ...
            if (_mcdiag) {
                ...
                if (DriftFitUtils::GetTestDOCA(
                        ...
                        < 2.5
                    and DOCA < 2.5 and abs(trueinfo.TrueFitEquation.Pos.X()) < 5000 and abs(trueinfo.TrueFitEquation.Pos.Y()) < 5000 and abs(trueinfo.TrueFitEquation.Dir.X()) < 5 and abs(trueinfo.TrueFitEquation.Dir.Y()) < 5) {
                    ...
                    outputfile
                        << DriftFitUtils::GetTestDOCA(
                               ...
                               trueinfo.TrueFitEquation.Dir.Y(), tracker)
                        << "," << DOCA << ","
                        << RecoAmbig / DriftFitUtils::GetAmbig(chit, trueinfo.TrueFitEquation.Pos.X(), trueinfo.TrueFitEquation.Dir.X(), trueinfo.TrueFitEquation.Pos.Y(), trueinfo.TrueFitEquation.Dir.Y(), tracker)
                        << "," << trueinfo.TrueTheta << ","
